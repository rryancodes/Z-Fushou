...
Rules:
- Maximum 2 short lines — keep it brief
- Describe only the issue or question being raised
- Note whether it is a question, complaint, or request
- Do NOT mention any usernames or Discord IDs — just describe the issue
- Do NOT quote messages verbatim
- Do NOT add preamble — state the issue directly
